		...
		<div className="flex flex-col w-screen h-screen justify-center items-center">
			<div className="lg:w-2/5 sm: w-4/5">
				...
				<h2 className="text-white text-justify py-8 text-base lg:text-xl xl:text-3xl">
					...
					movie?
					<br />
					MovieMatcher tries to provide a solution to this conundrum
					with a Tinder-like voting system.
					<br />
					Just enter a name, either create or join a room and select
					your desired genres and streaming services.
				</h2>
				<Button
					onClick={props.start}
